...
const spawnReplyInput = (parent, parentId, replyTo = undefined) => {
  ...
  addedInput.querySelector(".mybutton").addEventListener("click", () => {
...
const createCommentNode = (commentObject) => {
  const commentTemplate = document.querySelector(".mytemplate");
  ...
  commentNode.querySelector(".markscores").textContent = commentObject.score;
  commentNode.querySelector(".cmnt-at").textContent = commentObject.createdAt;
  commentNode.querySelector(".textbody").textContent = commentObject.content;
  ...
  if (commentObject.user.username == data.currentUser.username) {
    ...
    commentNode.querySelector(".edit").addEventListener("click", (e) => {
      const path = e.path[3].querySelector(".textbody");
      if (
...
cmntInput.querySelector(".mybutton").addEventListener("click", () => {
